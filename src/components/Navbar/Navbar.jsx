        ...
        <div>
            <AppBar>
               <Toolbar sx={{display: 'flex', justifyContent: 'space-between'}}> 
                ...
                {screenSize ? <DrawerComponent/>: 
                <>
                <Link sx={{display: {sm: 'none'}}} to="home" spy={true} smooth={true} offset={-200} duration={500} className="navbar-link"><Typography className='navtext' variant="h3"style={{fontSize: 35, letterSpacing: 2, color:"white"}}>Home</Typography> </Link>
